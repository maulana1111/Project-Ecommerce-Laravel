...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        ...
        <div class="body">
            <form action="/Admin/memberArea/updateMember" method="POST">
                {{ csrf_field() }}
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{ $data->member_name }}" name="member_name" required>
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" class="form-control" value="{{ $data->telp }}" name="telpon" required>
                ...
                <div class="form-group form-float">
                    ...
                    <textarea id="" class="form-control" name="shipping_address" placeholder="Address"> {{ $data->shipping_address }}</textarea>
                </div>
